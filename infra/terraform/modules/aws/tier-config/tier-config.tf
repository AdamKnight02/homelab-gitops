# =============================================================================
# AWS Tier Configuration Module
# =============================================================================
# Central tier-to-resource mapping. This module defines what each service tier
# means in terms of AWS infrastructure. All other modules and the root module
# call this module to determine what to create.
#
# DESIGN PRINCIPLE: Tiers are intent declarations, not cloud SKUs.
# This module translates intent into AWS-specific resource decisions.
# =============================================================================
...
variable "aws_associate_public_ip" {
  description = "Whether public IPs are associated with instances."
  type        = bool
  default     = false
}
...
# ---------------------------------------------------------------------------
# Outputs — Exposed to root module and other modules
# ---------------------------------------------------------------------------
output "tier" {
  description = "Resolved tier name (lowercase)."
  value       = local.tier
}

output "instance_count" {
  description = "Number of EC2 instances for this tier."
...
output "cloudwatch_logs" {
  description = "Whether CloudWatch Logs export is enabled."
  value       = local.cloudwatch_logs
}
...
output "cost_report" {
  description = "Resource count summary for cost guardrail."
  value       = local.cost_report
}

output "estimated_monthly_cost" {
  description = "Estimated monthly cost in USD (rough)."
